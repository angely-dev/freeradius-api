...
post_group = {
    'groupname': 'g',
    'replies': [
        {'attribute': 'Filter-Id', 'op': ':=', 'value': '10m'}
    ]
}

post_group_bad_user = post_group | {
    'users': [
        {'username': 'non-existing-user', 'priority': 1}
    ]
}
...
post_user = {
    'username': 'u',
    'checks': [
        {'attribute': 'Cleartext-Password', 'op': ':=', 'value': 'my-pass'}
    ],
    'replies': [
...
post_user_bad_group = post_user | {
    'groups': [
        {'groupname': 'non-existing-group', 'priority': 1}
    ]
}

post_user_with_group = post_user | {
    'groups': [
        {'groupname': 'g', 'priority': 1}
    ]
}
