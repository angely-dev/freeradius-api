...
# Create dependencies list if API key is enabled
...
@router.get("/users", tags=["users"], status_code=200, response_model=List[str], dependencies=dependencies)
...
@router.get("/groups", tags=["groups"], status_code=200, response_model=List[str], dependencies=dependencies)
...
@router.get("/nas/{nasname}", tags=["nas"], status_code=200, response_model=Nas, responses={**e404_response}, dependencies=dependencies)
...
@router.post("/nas", tags=["nas"], status_code=201, response_model=Nas, responses={**e409_response}, dependencies=dependencies)
...
@router.put("/nas/{nasname}", tags=["nas"], status_code=200, response_model=Nas, responses={**e404_response}, dependencies=dependencies)
...
@router.patch("/nas/{nasname}", tags=["nas"], status_code=200, response_model=Nas, responses={**e404_response}, dependencies=dependencies)
...
@router.delete("/nas/{nasname}", tags=["nas"], status_code=204, responses={**e404_response}, dependencies=dependencies)
...
@router.get("/users/{username}", tags=["users"], status_code=200, response_model=User, responses={**e404_response}, dependencies=dependencies)
...
@router.post("/users", tags=["users"], status_code=201, response_model=User, responses={**e409_response}, dependencies=dependencies)
...
@router.put("/users/{username}", tags=["users"], status_code=200, response_model=User, responses={**e404_response}, dependencies=dependencies)
...
@router.patch("/users/{username}", tags=["users"], status_code=200, response_model=User, responses={**e404_response}, dependencies=dependencies)
...
@router.delete("/users/{username}", tags=["users"], status_code=204, responses={**e404_response}, dependencies=dependencies)
...
@router.get("/groups/{groupname}", tags=["groups"], status_code=200, response_model=Group, responses={**e404_response}, dependencies=dependencies)
...
@router.post("/groups", tags=["groups"], status_code=201, response_model=Group, responses={**e409_response}, dependencies=dependencies)
...
@router.put("/groups/{groupname}", tags=["groups"], status_code=200, response_model=Group, responses={**e404_response}, dependencies=dependencies)
...
@router.patch("/groups/{groupname}", tags=["groups"], status_code=200, response_model=Group, responses={**e404_response}, dependencies=dependencies)
...
@router.delete("/groups/{groupname}", tags=["groups"], status_code=204, responses={**e404_response}, dependencies=dependencies)
